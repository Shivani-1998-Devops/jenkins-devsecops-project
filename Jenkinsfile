...
pipeline {
    ...
    environment {
        ...
        NEXUS_PROTOCOL = "http"
        NEXUS_URL = "http://172.31.37.158:8081"
        ...
        IMAGE_NAME   = '470226122967.dkr.ecr.ap-south-1.amazonaws.com/vprofileappimg'               
        vprofileRegistry = "https://470226122967.dkr.ecr.ap-south-1.amazonaws.com"
    }
    ...
    post {
        always {
            ...
            emailext (
                ...
                """,
                to: 'shivaniburgahte@gmail.com',
                from: 'shivaniburgahte@gmail.com',
                mimeType: 'text/html',
